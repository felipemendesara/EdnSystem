...
<html>
	<head>
		...
		<title>EDN Eventos - Cadastro de Usuário</title>
		...
		<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
			<header class="mdl-layout__header">
				<div class="mdl-layout__header-row">
					<!-- Title -->
			        <span class="mdl-layout-title">EDN Eventos - Cadastro de usuários</span>
				</div>
			</header>
			<main class="mdl-layout__content login-background">
				<div class="page-content" id="conteudo"> <!-- Aqui começa o conteúdo principal -->
